...
exports.setUseStrictShallowCopy = exports.setUseStrictIteration = exports.setAutoFreeze = exports.produceWithPatches = exports.produce = void 0;
...
var produceWithPatches = exports.produceWithPatches = /* @__PURE__ */immer.produceWithPatches.bind(immer);
var setAutoFreeze = exports.setAutoFreeze = /* @__PURE__ */immer.setAutoFreeze.bind(immer);
var setUseStrictShallowCopy = exports.setUseStrictShallowCopy = /* @__PURE__ */immer.setUseStrictShallowCopy.bind(immer);
var setUseStrictIteration = exports.setUseStrictIteration = /* @__PURE__ */immer.setUseStrictIteration.bind(immer);
var applyPatches = exports.applyPatches = /* @__PURE__ */immer.applyPatches.bind(immer);
var createDraft = exports.createDraft = /* @__PURE__ */immer.createDraft.bind(immer);
var finishDraft = exports.finishDraft = /* @__PURE__ */immer.finishDraft.bind(immer);
...
function configureStore(options) {
  ...
  if ("development" !== "production" && duplicateMiddlewareCheck) {
    let middlewareReferences = /* @__PURE__ */new Set();
    finalMiddleware.forEach(middleware2 => {
      if (middlewareReferences.has(middleware2)) {
        throw new Error("development" === "production" ? formatProdErrorMessage(42) : "Duplicate middleware references found when creating the store. Ensure that each middleware is only included once.");
      }
...
function executeReducerBuilderCallback(builderCallback) {
  ...
  const builder = {
    ...
    addAsyncThunk(asyncThunk, reducers) {
      if ("development" !== "production") {
        if (defaultCaseReducer) {
          throw new Error("development" === "production" ? formatProdErrorMessage(43) : "`builder.addAsyncThunk` should only be called before calling `builder.addDefaultCase`");
        }
      }
...
(0, _immer.setUseStrictIteration)(false);
...
var btnDecrese = document.querySelector("#decrease");
...
btnDecrese.onClick = function () {
  store.dispatch(decrease());
};
},{"@reduxjs/toolkit":"node_modules/@reduxjs/toolkit/dist/redux-toolkit.legacy-esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
